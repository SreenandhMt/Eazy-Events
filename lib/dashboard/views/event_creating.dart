...
class _EventCreatingPageState extends State<EventCreatingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (viewModel.editEvent != null&&widget.eventID!=null) {
    ...
    }else if(viewModel.editEvent ==null&&widget.eventID!=null)
    {
      WidgetsBinding.instance.addPostFrameCallback((timeStamp) => context.pop()); 
    }
                ...
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ...
                      DashboardTextform(
                          text: "Type about here*", width: 480, maxLine: 10, maxLength: null,padding: 0,controller: aboutController,validator: (value){
  ...
  void clear()
  {
    ...
    context.read<DashboardViewModel>().setEventToEdit(null);
    setState(() {});
  }
}
