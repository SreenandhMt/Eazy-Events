...
class AppTheme {
  ...
  static final darkTheme = ThemeData.dark().copyWith(
    colorScheme: ColorScheme.dark(secondary: Colors.grey.shade800,tertiary: Colors.grey.shade700),
  ...
  static final lightTheme = ThemeData.light().copyWith(
    colorScheme: ColorScheme.light(secondary: Colors.grey.shade300,tertiary: Colors.grey.shade200),
    primaryColor: Colors.deepOrange[700],
    scaffoldBackgroundColor: Colors.grey.shade100,
    appBarTheme: AppBarTheme(backgroundColor: Colors.grey.shade100,elevation: 0),
    textTheme: TextTheme(
